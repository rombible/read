...
var selText = ""
var open = 0;
function vOpenNote(path)
{
	sURL = '../bibles/kjv/books/' + path; parent.postMessage('note:' + sURL, '*'); 
	open = 1;
} 
$(document).click(
	function(e)
	{
		if(open==2)parent.postMessage('note:restore', '*'); 
		open++;
	}
	);
...
window.addEventListener('message', 
	...
	{ 
		...
		{ 
			...
			{
				//alert(obj.split(':')[1]);
				window.location.hash = obj.split(':')[1];
			}
		}
	});  
